    ...
    function wcp_enqueue_scripts()
    {
        ...
        // Enqueue CSS
        wp_enqueue_style('wcp-css', plugins_url('assets/style.css', __FILE__), [], '1.0.0', 'all');

        // Enqueue JS
        wp_enqueue_script('wcp-js', plugins_url('assets/script.js', __FILE__), ['jquery'], '1.0.0', true);
    }
